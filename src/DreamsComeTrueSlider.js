        ...
        <div className='dreams-true-slider'>
            <Slider {...settings}>
                <div className='slider-sec'>
                    <Link to="/sustainable-custom-apparel"><img src={sustainCustomApparel} title='Sustainable Custom Apparel' alt='' /></Link>
                </div>
                <div className='slider-sec'>
                    <Link to="/products/text2design"><img src={text2design} title='Text 2 Designs' alt='' /></Link>
                </div>
                <div className='slider-sec'>
                    <Link to="/products/image2design"><img src={image2design} title='Image 2 Designs' alt='' /></Link>
                </div>
                <div className='slider-sec'>
                    <Link to="/products/sketch2design"><img src={sketch2design} title='Sketch 2 Designs' alt='' /></Link>
                </div>
            </Slider>
        </div>
    );
